========================================================================
    BIBLIOTH&Egrave;QUE DE LIENS DYNAMIQUES&nbsp;: Vue d'ensemble du projet OtherLib
========================================================================

AppWizard a cr&eacute;&eacute; cette DLL OtherLib pour vous.

Ce fichier contient un r&eacute;sum&eacute; des &eacute;l&eacute;ments contenus dans chaque fichier qui
constitue votre application OtherLib.
...
StdAfx.h, StdAfx.cpp
    ...
    nomm&eacute; OtherLib.pch et un fichier de types pr&eacute;compil&eacute;s nomm&eacute; StdAfx.obj.
